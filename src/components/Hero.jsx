          ...
          <div className="text-center order-2 lg:order-1">
            ...
            <div className="flex items-center justify-center gap-6 mb-8">
              <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm border border-white/50">
                  <div className="w-2 h-2 bg-[#C7E9B0] rounded-full animate-pulse"></div>
                <span className="text-sm font-medium text-[#1A1A1A]">Trusted by 500+ Schools</span>
              </div>
              <div className="flex items-center gap-2 bg-white/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm border border-white/50">
                  <div className="w-2 h-2 bg-[#74C0E3] rounded-full animate-pulse"></div>
                <span className="text-sm font-medium text-[#1A1A1A]">20+ Years Experience</span>
              </div>
            </div>
